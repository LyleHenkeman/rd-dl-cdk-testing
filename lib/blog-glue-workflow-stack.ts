...
const rptJobMartRawTable = "rpt_jobmart_raw";
const parquetPath = "/processed-data/"
const src_bucket = "rd-dl-raw";
...
export class BlogGlueWorkFlowStack extends cdk.Stack {
  ...
  constructor(scope: cdk.App, id: string, props?: cdk.StackProps) {
    ...
    const jobmart = "s3://" + assetBucketName + "/" + rawPath;
    const processed = "s3://" + assetBucketName + "/" + processedPath;
    ...
    const glue_job_asset = new glue.CfnJob(this, "glue-job-asset", {
      ...
      defaultArguments: {
        ...
        "--Prefix": rawPath,
        "--target_hiringPrefix": processedPath,
